# 投稿记录：Nature Machine Intelligence（2026-09-17 提交 → 2026-09-18 编辑退稿）
...
| 2026-09-18 | **编辑退稿**（desk rejection，未送外审） | 主编邮件（Liesbeth Venema） |
...
Nature Machine Intelligence 编辑部直接退稿，**没有送外审**（desk rejection）。主编 Liesbeth Venema 邮件要点：

> 虽然我们承认您的发现本身具有重要意义，但我遗憾地无法得出结论，认为这篇论文在科学理解上提供了明确且有力的进展，从而立即引起我们人工智能和机器学习研究者的关注。我们认为本稿更适合发表于其他期刊。

解读：

* 不是技术性否定（没有审稿人，也就没有任何具体科学质疑）；
* 编辑给的两个理由是：**期刊读者的兴趣定位不匹配**，以及**"进展的力度/清晰度"不够**；
* 顶刊编辑退稿一般不接受申诉；
* 因为没有送外审，本篇不存在"已在别处发表/正在审议"的问题，**可以立刻转投其他期刊**。
